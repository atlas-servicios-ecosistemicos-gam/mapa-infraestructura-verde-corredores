---
title: "Mapa de infraestructura verde de los corredores biológicos interurbanos María Aguilar y Río Torres"
output: 
...
url_raster_infraestructura_verde <-
  "https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos/master/infraestructura-verde/corredores/IV_CORREDORES_WEB.TIF"

#--------------- Objetos sf y raster --------------

# Límite de corredores
sf_limite_corredores <- 
  esri2sf(url_agfs_limite_corredores)

# Límite de corredores (reproyectado a Web Mercator)
...
raster_infraestructura_verde <-
  ...
  aggregate(fact=3, fun=modal) %>% # ¡¡HAY QUE TRATAR DE ELIMINAR ESTA AGRUPACIÓN. PODRÍA FUNCIONAR AL USAR MÁS MEMORIA LINUX!!
...
### Datos para descarga: [Capa geoespacial de infraestructura verde de los corredores biológicos interurbanos María Aguilar y Río Torres](https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos/master/infraestructura-verde/corredores/IV_CORREDORES.TIF)
```{r}
...
leaflet() %>%
  ...
  addLayersControl(
    ...
    overlayGroups = c("Límite de los corredores", "Infraestructura verde"),
